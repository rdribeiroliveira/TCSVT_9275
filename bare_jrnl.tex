...
\textcolor{blue}{This kind of application is directed to vertical markets specially those that focus on tv subscription operators that frequently replace all receivers of network. In this case the reuse of receivers could bring a lot of benefits for the tv operator. Beyond of the fixed receivers if were considered the replacement of mobile devices the envolved costs are unworkable}
...
\textcolor{red}{rodrigo, encontre pelo menos mais um trabalho e coloque aqui. Tente achar algo híbrido entre software e hardware~\cite{Ribeiro12}.}
