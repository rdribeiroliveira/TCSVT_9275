...
\textcolor{blue}{It is worth noticing that the proposed scheme presents some overhead, which is related to the encapsulation in private sections, that is, the private section header, and SVF file format, which includes JTAG commands. \textcolor{red}{rodrigo, quantifique o overhead... em bytes}) } 
