...
\textcolor{red}{falar que o principal nicho desta aplicação são os merdados verticais, pois as operadoras por assinatura gostariam de não trocar os receptores... fale tambem que ficaria difícil para dispositivos móveis}
...
\textcolor{red}{rodrigo, aqui, ou em uma seção antes desta, coloque aquele estudo complwto sobre como chegar a metodologia que voce escolheu... aquela estoria de dados limitados, ilimitados, seções, data piping, etc.}
